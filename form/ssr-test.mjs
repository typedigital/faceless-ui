...
/**
 * SSR Test for <faceless-form> + <faceless-input> + <faceless-checkbox>
 *
...
const sections = [
  ...
  {
    id: 'ssr-form-cb',
    title: '8. Checkbox + Radio Group (faceless-checkbox)',
    description: '<code>&lt;faceless-checkbox&gt;</code> with pre-rendered light DOM. Checkboxes and radio buttons with implicit label association.',
    html: `
    <faceless-form aria-label="Checkbox test form">
      <form novalidate>
        <faceless-checkbox name="terms" label="I accept the terms" required
        ...
        <faceless-checkbox name="newsletter" label="Subscribe to newsletter"
                           hint="Optional — unsubscribe any time."
                           data-field="newsletter">
          <label data-label>
            <input data-input type="checkbox" name="newsletter" value="on">
            <span data-label-text>Subscribe to newsletter</span>
          </label>
          <span data-hint>Optional — unsubscribe any time.</span>
          <span data-error></span>
        </faceless-checkbox>
        <p style="font-weight:600;font-size:0.875rem;margin:16px 0 8px;">Choose a plan</p>
        <faceless-checkbox name="plan" type="radio" label="Free" value="free" required
                           error-required="Please choose a plan."
                           data-field="plan">
          <label data-label>
            <input data-input type="radio" name="plan" value="free" required>
            <span data-label-text>Free</span>
          </label>
          <span data-error></span>
        </faceless-checkbox>
        <faceless-checkbox name="plan" type="radio" label="Pro" value="pro"
                           data-field="plan">
          <label data-label>
            <input data-input type="radio" name="plan" value="pro">
            <span data-label-text>Pro</span>
          </label>
          <span data-error></span>
        </faceless-checkbox>
        <faceless-checkbox name="plan" type="radio" label="Enterprise" value="enterprise"
                           data-field="plan">
          <label data-label>
            <input data-input type="radio" name="plan" value="enterprise">
            <span data-label-text>Enterprise</span>
          </label>
          <span data-error></span>
        </faceless-checkbox>
...
<body>
  ...
  <p class="claim">Universal rendering with &lt;faceless-form&gt; + &lt;faceless-input&gt; + &lt;faceless-checkbox&gt; — progressive enhancement from static HTML</p>
  ...
  <div class="ssr-concept-banner">
    ...
    <p>
      ...
      <code>index.js</code> can be imported server-side without errors.
      <code>&lt;faceless-form&gt;</code>, <code>&lt;faceless-input&gt;</code>, and
      <code>&lt;faceless-checkbox&gt;</code> are all safe to import in Node.js, Deno, and edge runtimes.
    </p>
    <p>
